      ...
      <div className="hero-content text-center">
        <div className="max-w-md flex flex-col items-center">
          <svg
            ...
            viewBox="0 0 256 256"
            className="fill-base-300 size-36"
          >
          ...
          <p className="py-4">
            Du hast gerade noch kein Projekt geöffnet. Öffne oben über
            "Projekte" ein schon erstelltes Projekt oder fang hier ein neues an!
          </p>
